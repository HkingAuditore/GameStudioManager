...
<body style="">
    <div class="container-fluid">
        <div class="row">
            <div style="background: rgb(122, 185, 209); padding-bottom: 5%;"></div>
        </div>
        ...
        <div class="row" style="padding-bottom: 5%">
            ...
            <div class="col-lg-offset-3 col-lg-2 col-md-offset-3 col-md-1 col-sm-offset-2 col-sm-1" style="position: fixed">
                <div class="triangle-front" style="position: absolute; padding: 200%;
                                             z-index: 3;margin-left: 280%"></div>
                <div class="triangle-behind" style="position: absolute; padding: 200%;
                                             z-index: 1; margin-left: 230%;margin-top: -50%;"></div>
                

                <div class="rg-panel" style="position: absolute; width: 140%; height: 24em;
                                             z-index: 4; margin-left: 230%;margin-top: 60%;">
                    <form id="form1" runat="server">
                        <div class="container-fluid" style="margin-top: 12%;margin-left:9%">
                            ...
                            <div class="row" style="margin-top: 8%;">
                                <div class="col-lg-offset-5 col-lg-3" style="font-size: 1.5em;text-align: right">
                                    <asp:Button ID="Confirm" runat="server" Text="确认" CssClass="btn btn-primary" OnClick="Confirm_OnClick"/>
                                </div>
                                <div class="col-lg-3" style="font-size: 1.5em;">
                                    <asp:Button ID="Register" runat="server" Text="注册" CssClass="btn btn-success"/>
                                </div>
                            </div>
                        </div>
                    </form>
